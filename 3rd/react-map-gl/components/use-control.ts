import {useContext, useMemo, useEffect} from 'preact/compat';
import type {IControl, ControlPosition} from '../types/index.ts';
import {MapContext} from './map.tsx';
import type {MapContextValue} from './map.tsx';
