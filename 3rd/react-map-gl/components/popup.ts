...
import {useImperativeHandle, useEffect, useMemo, useRef, useContext, forwardRef, memo} from 'preact/compat';
import {applyReactStyle} from '../utils/apply-react-style.ts';

import type {PopupEvent, PopupInstance} from '../types/index.ts';
