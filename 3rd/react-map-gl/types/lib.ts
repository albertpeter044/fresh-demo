import type {PaddingOptions, LngLat, Point, LngLatLike, PointLike, ControlPosition} from './common.ts';
...
export interface Evented {
  ...
  off(type?: string | any, listener?: Listener):void;
...
export interface MapInstance extends Evented {
  ...
  fire(type: string, properties?: {[key: string]: any}):void;

  addControl(control: IControl<this>, position?: ControlPosition):void;

  removeControl(control: IControl<this>):void;
  ...
  setStyle(style: any, options?: any):void;
  ...
  setFilter(layer: string, filter?: any[] | boolean | null):void;
  ...
  setLight?(options: any, lightOptions?: any):void;
